...
const QAPage = () => {
   ...
   */
  const safeIndex = Math.min(questionIndex, (questions?.length || 1) - 1)
        ...
        <SheetContent className='sm:max-w-[80vw] overflow-y-auto'>
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <MarkdownPreview
                source={question.answer || "No answer available"}
            ...
            {/* Code References */}
            {Array.isArray(question.filesRefrences) && question.filesRefrences.length > 0 && (
              <div className="mt-4">
                <h3 className="text-sm font-semibold mb-2">
                  Referenced Files ({question.filesRefrences.length})
                </h3>
